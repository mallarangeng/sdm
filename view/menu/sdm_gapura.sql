...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2018 at 06:17 AM
...
('1712.0909', 'Kuncoro Di Aji', 'L', 'Jakarta', '2018-01-16', '-', '', 3, 5, 9003, '2018-01-24', 'SDM', 'CGO', 'OS', '2018-01-17', '', '', 0, 'Aktif', '0000-00-00', '-', 2, '013a28fce062010f1185e357c4c0d2b0', '1712.0905', '2018-01-05 14:32:28', 'undefined', '0000-00-00 00:00:00'),
...
--
ALTER TABLE `apsensi`
  MODIFY `id_apsensi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `datafile`
--
ALTER TABLE `datafile`
  MODIFY `kode_file` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
