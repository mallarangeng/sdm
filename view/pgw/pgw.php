    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <div class="modal fade hmodal-success" id="modal-pgw-pendidikan" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="panel-body">
					<button type="button" class="tambah-pgw btn btn-primary">Tambah Pegawai</button>
					<p>
					<div id="hasil"></div>
					<p>
					<div id="data-pgw"></div>
